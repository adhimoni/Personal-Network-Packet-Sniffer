...
#Personal Network Packet Sniffer in Linux Environment python
...
while True:
	...
	if ethernet_protocol == 8:
		...
		if ethernet_protocol == 6:
		    ...
		    print 'Destination MAC:\t' + ethernet_address(packet_data[0:6]) 
		    print 'Source MAC:\t\t' + ethernet_address(packet_data[6:12]) 
		    print 'Protocol:\t\t' + str(ethernet_protocol)
		...
		#ICMP Protocol
			...
			print 'Source MAC:\t\t' + ethernet_address(packet_data[6:12]) 
			print 'Protocol:\t\t' + str(ethernet_protocol)
			print 'ICMP, Internet Control Message Protocol'
			print 'Type :\t\t\t' + str(icmp_type)
			print 'Code :\t\t\t' + str(code)
			print 'Checksum:\t\t\t ' + str(checksum)
			
		#UDP Protocol
		elif ethernet_protocol == 17:
			...
			destination_port_port = udp_header_unpack[1]
			...
			print 'Source MAC:\t\t' + ethernet_address(packet_data[6:12]) 
			print 'Protocol:\t\t' + str(ethernet_protocol)
			print 'UDP, Universal Datagram Protocol'
			print 'Source Port:'+str(source_port)
